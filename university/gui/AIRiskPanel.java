...
public class AIRiskPanel extends JPanel {
    ...
    public AIRiskPanel() {
        ...
        String[] columnNames = {"ID", "Name", "CGPA", "Attendance", "Placement Likelihood"};
    ...
    private void refreshAnalysis() {
        ...
        for (Student s : students) {
            ...
            tableModel.addRow(new Object[]{s.getId(), s.getName(), s.getCgpa(), s.getAttendancePercentage() + "%", likelihoodStr});
        }
    }
}
